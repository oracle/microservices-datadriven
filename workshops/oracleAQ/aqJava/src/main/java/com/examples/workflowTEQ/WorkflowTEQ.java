...
public class WorkflowTEQ {
	...
	public Map<Integer,String> pubSubWorkflowTEQ() throws JMSException, AQException, SQLException, ClassNotFoundException, JsonMappingException, JsonProcessingException {
