...
-- 3: APPLICATION SHARES OTP TO USER
    applicationToUser_message := enqueueDequeueTEQ('teq_appUserSubscriber', 'teq_ApplicationQueue', Message_typ(userToApplication_message.ORDERID, userToApplication_message.USERNAME, otp, userToApplication_message.DELIVERY_STATUS, userToApplication_message.DELIVERY_LOCATION));
...
-- 4: APPLICATION SHARES DELIVERY DETAILS TO DELIVERER
    applicationToDeliverer_message  := enqueueDequeueTEQ('teq_appDelivererSubscriber', 'teq_ApplicationQueue', Message_typ(applicationToUser_message.ORDERID, applicationToUser_message.USERNAME, 0, applicationToUser_message.DELIVERY_STATUS, applicationToUser_message.DELIVERY_LOCATION));
...
-- 5: User shares OTP to DELIVERER
    userToDeliverer_message  := enqueueDequeueTEQ('teq_userDelivererSubscriber', 'teq_UserQueue', Message_typ(applicationToUser_message.ORDERID, applicationToUser_message.USERNAME, applicationToUser_message.OTP, applicationToUser_message.DELIVERY_STATUS, applicationToUser_message.DELIVERY_LOCATION));
...
-- 6: DELIVERER TO APPLICATION FOR OTP VERIFICATION
    delivererToApplication_message  := enqueueDequeueTEQ('teq_delivererAppSubscriber', 'teq_DelivererQueue', Message_typ(userToDeliverer_message.ORDERID, userToDeliverer_message.USERNAME, userToDeliverer_message.OTP, userToDeliverer_message.DELIVERY_STATUS, userToDeliverer_message.DELIVERY_LOCATION));
...
-- 8: APPLICATION UPDATE DELIVERER TO DELIVER ORDER
    applicationToDeliverer_message  := enqueueDequeueTEQ('teq_appDelivererSubscriber', 'teq_ApplicationQueue', Message_typ(delivererToApplication_message.ORDERID, delivererToApplication_message.USERNAME, delivererToApplication_message.OTP, status, delivererToApplication_message.DELIVERY_LOCATION));
...
-- 9: APPLICATION UPDATE USER FOR DELIVERED ORDER
    applicationToUser_message  := enqueueDequeueTEQ('teq_appUserSubscriber', 'teq_ApplicationQueue', Message_typ(delivererToApplication_message.ORDERID, delivererToApplication_message.USERNAME, otp, status, delivererToApplication_message.DELIVERY_LOCATION));
