...
ORDER_DB_ALIAS=$(state_get ORDER_DB_ALIAS)
INVENTORY_DB_TNS_ADMIN=$(state_get INVENTORY_DB_TNS_ADMIN)
INVENTORY_DB_ALIAS=$(state_get INVENTORY_DB_ALIAS)
ORDER_DB_CWALLET_SSO_AUTH_URL='$(state_get ORDER_DB_CWALLET_SSO_AUTH_URL)'
INVENTORY_DB_CWALLET_SSO_AUTH_URL='$(state_get INVENTORY_DB_CWALLET_SSO_AUTH_URL)'
