...
sed -i 's/BOOTSTRAP_SRV/'"${bootstrap_server}"'/g' "$LAB_HOME/springboot-oracleteq/okafka-producer/src/main/resources/application.yaml"
sed -i 's/BOOTSTRAP_SRV/'"${bootstrap_server}"'/g' "$LAB_HOME/springboot-oracleteq/okafka-consumer/src/main/resources/application.yaml"
...
sed -i 's/SERVICE_NAME/'"${oracle_service_name}"'/g' "$LAB_HOME/springboot-oracleteq/okafka-producer/src/main/resources/application.yaml"
sed -i 's/SERVICE_NAME/'"${oracle_service_name}"'/g' "$LAB_HOME/springboot-oracleteq/okafka-consumer/src/main/resources/application.yaml"
