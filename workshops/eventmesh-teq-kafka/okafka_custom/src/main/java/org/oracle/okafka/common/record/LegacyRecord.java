...
import static org.oracle.okafka.common.utils.Utils.wrapNullable;
...
import org.oracle.okafka.common.utils.ByteBufferOutputStream;
import org.oracle.okafka.common.utils.ByteUtils;
import org.oracle.okafka.common.utils.Checksums;
import org.oracle.okafka.common.utils.Crc32;
...
public final class LegacyRecord {
    ...
    public String toString() {
        if (magic() > 0)
            return String.format("Record(magic=%d, attributes=%d, crc=%d, %s=%d, key=%d bytes, value=%d bytes)",
                                 magic(),
                                 attributes(),
                                 checksum(),
                                 timestampType(),
