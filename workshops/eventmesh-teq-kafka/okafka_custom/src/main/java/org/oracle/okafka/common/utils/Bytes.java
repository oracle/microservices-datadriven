...
public class Bytes implements Comparable<Bytes> {
     ...
     */
    public final static LexicographicByteArrayComparator BYTES_LEXICO_COMPARATOR = new LexicographicByteArrayComparator();
    ...
    private static class LexicographicByteArrayComparator implements Comparator<byte[]>, Serializable{
