package com.oracle.developers.eventmesh.teq.okafka;
...
@ComponentScan(basePackages = "com.oracle.developers.eventmesh.teq.okafka",
		excludeFilters =
		@ComponentScan.Filter(type= FilterType.REGEX,
				pattern="com\\.oracle\\.developers\\.eventmesh\\.teq\\.okafka\\.config\\.consumer\\..*"))
