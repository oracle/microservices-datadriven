...
/**
 * A metric tracked for monitoring purposes. Metrics feature is not yet supported.
 */
public interface Metric {
     ...
     *
     * @deprecated As of kafka 1.0.0, use {@link #metricValue()} instead. This will be removed in a future major release.
     */
    @Deprecated
    double value();
