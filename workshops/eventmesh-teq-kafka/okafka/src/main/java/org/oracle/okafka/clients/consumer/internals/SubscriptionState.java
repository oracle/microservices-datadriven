...
import org.oracle.okafka.common.internals.PartitionStates;
...
public class SubscriptionState {
    ...
    /* Tracks last consumed offset for each topic partition */
    ...
    private TopicPartitionState assignedState(TopicPartition tp) {
        ...
        if (state == null)
            this.assignment.add(new TopicPartition(tp.topic(), tp.partition()), new TopicPartitionState());
    ...
    private static class TopicPartitionState {
       ...
       private void seek(long offset) {
            ...
            this.resetStrategy = OffsetResetStrategy.TO_OFFSET;
            this.nextAllowedRetryTimeMs = null;
        }
