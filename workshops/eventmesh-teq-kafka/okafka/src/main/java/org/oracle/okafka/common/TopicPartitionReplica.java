...
/**
 * The topic name, partition number and the brokerId of the replica. This class is added only to represent public api. 
 * This class has no meaning in TEQ as there is no replication.
 */
