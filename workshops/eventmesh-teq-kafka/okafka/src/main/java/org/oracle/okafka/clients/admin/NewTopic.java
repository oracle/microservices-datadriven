...
public class NewTopic {
    ...
    /**
     * A new topic with the specified replication factor and number of partitions. Replication factor is not necessary for TEQ. Hence this value is ignored.
     */
     ...
     * @param replicasAssignments ReplicaAssignments factor is not necessary for TEQ. Hence this value is ignored.
     */
