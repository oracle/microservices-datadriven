...
public class ImplementionWithoutOSaga implements Runnable {
    ...
    public String beginSaga(Connection connection, String orderid) {
    ...
    public void logSaga(Connection connection, String orderid, String sagaId) {
        PreparedStatement cstmt = null;
        try {
    ...
    public void logAndAddFlightParticipantToSaga(Connection connection, String orderid, String sagaId) {
        PreparedStatement cstmt = null;
        try {
            cstmt = connection.prepareCall("insert into travelagency_participants_sagastate(?,?,?)");
            cstmt.setString(1, sagaId);
    ...
    public void saveFlightInventoryBeforeStateInDevotedInventoryJournalTable(Connection connection, String orderid, String sagaId) throws SQLException {
    ...
    public void reserveFlight(Connection connection, String orderid, String sagaId) throws SQLException {
        try (OraclePreparedStatement st = (OraclePreparedStatement)
    ...
    public void addHotelParticipantToSaga(Connection connection, String orderid, String sagaId) {
        PreparedStatement cstmt = null;
        try {
            cstmt = connection.prepareCall("insert into travelagency_participants_sagastate(?,?,?)");
            cstmt.setString(1, sagaId);
    ...
    public void saveHotelInventoryBeforeStateInDevotedInventoryJournalTable(Connection connection, String orderid, String sagaId) throws SQLException {
        try (OraclePreparedStatement st = (OraclePreparedStatement)
                connection.prepareStatement(
    ...
    public void adjustHotelInventory(Connection connection, String orderid, String sagaId) throws SQLException {
        try (OraclePreparedStatement st = (OraclePreparedStatement)
    ...
    public void setStateToCommittingOnSaga(Connection connection, String orderid, String sagaId) throws SQLException {
    ...
    public void callCommitOnAllParticipants(Connection connection, String orderid, String sagaId) {
        // call commit/cleanup on participants
        // participants purge journal tables
    }

    public void setStateToCommittedOnParticipants(Connection connection, String orderid, String sagaId) {
    }



    public void setStateToRollingbackOnSaga(Connection connection, String orderid, String sagaId) throws SQLException {
        PreparedStatement cstmt = connection.prepareCall("update sagastate set state = ? where sagaId = ?");
        cstmt.setString(2, sagaId);
    ...
    public void callRollbackOnAllParticipants(Connection connection, String orderid, String sagaId) {
    }


    public void setStateToRolledbackOnParticipants(Connection connection, String orderid, String sagaId) {
    }

    public void purgeSagaAndParticipantEntries(Connection connection, String orderid, String sagaId) throws SQLException {
...
//            connection.createStatement().execute("create table flightparticipant_sagajournal(sagaid varchar(64), inventorycount integer)");
//            connection.createStatement().execute("create table hotelparticipant_sagajournal(sagaid varchar(64), inventorycount integer)");
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    }
