...
for render in \
  ...
  assert_contains "${render}" 'image: docker.io/signoz/signoz:v0.133.0'
...
assert_not_contains "${STANDARD_RENDER}" 'signoz-upgrade-0-133-stage1'
assert_not_contains "${STAGE2_INSTALL_RENDER}" 'signoz-upgrade-0-133-stage1'
...
assert_not_contains "${STAGE1_RENDER}" 'image: docker.io/signoz/signoz:v0.133.0'
...
assert_not_contains "${STAGE1_RENDER}" 'signoz-upgrade-0-133-stage1'
