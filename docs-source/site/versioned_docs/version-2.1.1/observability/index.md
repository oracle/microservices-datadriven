...
| [Replace SigNoZ during upgrade](./upgrade/index.md) | Replace SigNoZ during an optional OBaaS 2.1.1 upgrade; existing observability data is permanently deleted |
