...
Upgrading an existing OBaaS release replaces SigNoZ rather than migrating it.
...
upgrade, Helm fails before changing any OBaaS resources. Customers who require
a data-preserving upgrade must follow SigNoZ's own documentation; that path is
