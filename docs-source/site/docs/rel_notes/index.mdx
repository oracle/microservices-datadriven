...
| Cert Manager (CA Injector) | `quay.io/jetstack/cert-manager-cainjector` | v1.19.5 |
| Cert Manager (Controller) | `quay.io/jetstack/cert-manager-controller` | v1.19.5 |
| Cert Manager (Webhook) | `quay.io/jetstack/cert-manager-webhook` | v1.19.5 |
...
| Config Server | `container-registry.oracle.com/obaas/config-server` | 2.0.0 |
| Curl | `docker.io/curlimages/curl` | 8.20.0 |
| Dashboards | `container-registry.oracle.com/obaas/dashboards` | 2.0.0 |
| Envoy | `docker.io/envoyproxy/envoy` | distroless-v1.37.0 |
| Envoy Gateway | `docker.io/envoyproxy/gateway` | v1.7.0 |
| etcd | `docker.io/bitnamilegacy/etcd` | 3.6.1 |
| Eureka | `container-registry.oracle.com/obaas/service-registry` | 2.0.0 |
...
| OBaaS Admin Server | `container-registry.oracle.com/obaas/admin-server` | 2.0.0 |
...
| OpenTelemetry Java Autoinstrumentation | `ghcr.io/open-telemetry/opentelemetry-operator/autoinstrumentation-java` | 1.33.6 |
| OpenTelemetry Operator | `ghcr.io/open-telemetry/opentelemetry-operator/opentelemetry-operator` | 0.146.0 |
