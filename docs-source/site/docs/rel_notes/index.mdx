...
| Cert Manager (CA Injector) | `quay.io/jetstack/cert-manager-cainjector` | v1.21.0 |
| Cert Manager (Controller) | `quay.io/jetstack/cert-manager-controller` | v1.21.0 |
| Cert Manager (Startup API Check) | `quay.io/jetstack/cert-manager-startupapicheck` | v1.21.0 |
| Cert Manager (Webhook) | `quay.io/jetstack/cert-manager-webhook` | v1.21.0 |
