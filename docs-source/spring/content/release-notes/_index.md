...
| Strimzi - Apache Kafka Operator       | 0.33.1        | Manages Kafka clusters                                                                  |
...
| Grafana                      | 9.2.5        | Tool to examine, analyze, and monitor metrics.                                  |
...
| Spring Boot Admin server          | 2.7.5        | Managing and monitoring Spring Boot applications.                                        |
