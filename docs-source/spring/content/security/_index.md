...
- Accessing the dashboards can only be done using port-forwarding. The passwords for the dashboards are provided by the installer or autogenerated and stored in Kubernetes secrets.
