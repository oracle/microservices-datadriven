...
public class ImplementionWithOSaga {
    ...
    String beginOSaga(Connection connection, String travelagencyid)  throws SQLException {
    ...
    void reserveFlight(Connection connection, String travelagencyid, String sagaId)  throws SQLException {
    ...
    public void reserveHotel(Connection connection, String travelagencyid, String sagaId) throws SQLException {
