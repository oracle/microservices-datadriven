...
# Java Home
if test -d ~/graalvm-ce-java11-20.2.0/Contents/Home/bin; then
  # We are on Mac doing local dev
  ~/graalvm-ce-java11-20.2.0/Contents/Home/bin/gu install native-image
  JAVA_HOME=~/graalvm-ce-java11-20.2.0/Contents/Home;
else
  # Assume linux
