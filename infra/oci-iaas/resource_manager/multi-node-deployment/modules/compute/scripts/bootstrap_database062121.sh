...
USAGE_INFO="
    =================================================================================================
                            ...
                            ================================================
    Microservices Datadriven Infrastructure is now available for usage

    For additional details regarding Microservices Datadriven applications on Oracle Converged Database check,
...
sudo -u ${USER_NAME}  $INFRA_HOME/oci-iaas/grabdish-adapter/database/update_tnsnames-ora.sh
