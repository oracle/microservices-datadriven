...
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-dotnet
$GRABDISH_HOME/inventory-dotnet/undeploy.sh

$GRABDISH_HOME/inventory-go/deploy.sh
echo TESTING inventory-go
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-go
$GRABDISH_HOME/inventory-go/undeploy.sh

$GRABDISH_HOME/inventory-helidon-se/deploy.sh
echo TESTING inventory-helidon-se
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-helidon-se
...
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-micronaut
$GRABDISH_HOME/inventory-micronaut/undeploy.sh

$GRABDISH_HOME/inventory-plsql/deploy.sh
echo TESTING inventory-plsql
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-plsql
...
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-python
$GRABDISH_HOME/inventory-python/undeploy.sh

$GRABDISH_HOME/inventory-quarkus/deploy.sh
echo TESTING inventory-quarkus
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-quarkus
$GRABDISH_HOME/inventory-quarkus/undeploy.sh

$GRABDISH_HOME/inventory-nodejs/deploy.sh
echo TESTING inventory-nodejs
mvn surefire:test -Dtest=oracle.modernappdev.WalkThroughTest -DsurefireReportsDirectory=target/surefire-reports/polyglot/inventory-nodejs
