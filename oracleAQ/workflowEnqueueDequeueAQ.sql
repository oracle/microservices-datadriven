...
--Step 4:
    applicationToDeliverer_message  := enqueueDequeue('plsql_appDelivererSubscriber', 'plsql_ApplicationQueue', 
          Message_typ(applicationToUser_message.ORDERID, applicationToUser_message.USERNAME, 0, applicationToUser_message.DELIVERY_STATUS, applicationToUser_message.DELIVERY_LOCATION));

-- 5: User shares OTP to DELIVERER
    userToDeliverer_message  := enqueueDequeue('plsql_userDelivererSubscriber', 'plsql_UserQueue', 
          Message_typ(applicationToUser_message.ORDERID, applicationToUser_message.USERNAME, applicationToUser_message.OTP, applicationToUser_message.DELIVERY_STATUS, applicationToUser_message.DELIVERY_LOCATION));
