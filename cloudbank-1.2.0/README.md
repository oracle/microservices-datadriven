# CloudBank Version 1.2.0

**NOTE:** This document and application is WIP.

To run Cloud Bank you need OBaaS version 1.2.0 (Not released) [Oracle Backend for Spring Boot and Microservices](https://cloudmarketplace.oracle.com/marketplace/en_US/listing/138899911)
...
1. Clone the source repository
   ...
   ```shell
   git clone -b CB-1.2.0 https://github.com/oracle/microservices-datadriven.git
   ```

1. Got to the `CloudBank-v32` directory

   ```shell
   cd microservices-datadriven/cloudbank-1.2.0
   ```
