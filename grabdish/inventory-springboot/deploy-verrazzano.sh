...
sed_i "s|%DOCKER_REGISTRY%|${DOCKER_REGISTRY}|g" inventory-springboot-comp-$CURRENTTIME.yaml
sed_i "s|%INVENTORY_PDB_NAME%|${INVENTORY_PDB_NAME}|g" inventory-springboot-comp-${CURRENTTIME}.yaml
sed_i "s|%OCI_REGION%|${OCI_REGION}|g" inventory-springboot-comp-${CURRENTTIME}.yaml
sed_i "s|%VAULT_SECRET_OCID%|${VAULT_SECRET_OCID}|g" inventory-springboot-comp-${CURRENTTIME}.yaml
