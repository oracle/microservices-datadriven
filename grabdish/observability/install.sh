...
echo install serviceaccount, clusterrole, and clusterrole binding needed for prometheus (default pw is admin/prom-operator)
...
echo install loki-stack with promtail
