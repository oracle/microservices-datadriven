...
mv -- /tmp/db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml
sed -e  "s|%PDB_NAME%|${ORDER_DB_NAME}|g" db-log-exporter-orderpdb-deployment-${CURRENTTIME}.yaml > /tmp/db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml
mv -- /tmp/db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml
...
mv -- /tmp/db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml
sed -e  "s|%db-wallet-secret%|order-db-tns-admin-secret|g" db-log-exporter-orderpdb-deployment-${CURRENTTIME}.yaml > /tmp/db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml
mv -- /tmp/db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml db-log-exporter-orderpdb-deployment-$CURRENTTIME.yaml
