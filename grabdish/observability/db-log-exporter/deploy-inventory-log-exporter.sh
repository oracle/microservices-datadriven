...
sed_i "s|%EXPORTER_NAME%|inventorypdb|g" db-log-exporter-deployment-${CURRENTTIME}.yaml
sed_i "s|%PDB_NAME%|${INVENTORY_PDB_NAME}|g" db-log-exporter-deployment-${CURRENTTIME}.yaml
sed_i "s|%USER%|INVENTORYUSER|g" db-log-exporter-deployment-${CURRENTTIME}.yaml
