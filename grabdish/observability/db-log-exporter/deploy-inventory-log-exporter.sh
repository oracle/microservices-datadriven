...
mv -- /tmp/db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml
sed -e  "s|%PDB_NAME%|${INVENTORY_DB_NAME}|g" db-log-exporter-inventorypdb-deployment-${CURRENTTIME}.yaml > /tmp/db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml
mv -- /tmp/db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml
...
mv -- /tmp/db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml
sed -e  "s|%db-wallet-secret%|inventory-db-tns-admin-secret|g" db-log-exporter-inventorypdb-deployment-${CURRENTTIME}.yaml > /tmp/db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml
mv -- /tmp/db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml db-log-exporter-inventorypdb-deployment-$CURRENTTIME.yaml
