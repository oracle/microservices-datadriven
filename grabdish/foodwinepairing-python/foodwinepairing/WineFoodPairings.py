...
wine_variety_vectors = pd.read_csv(r'wine_aromas_nonaromas.csv', index_col='Unnamed: 0')
...
descriptor_frequencies = pd.read_csv(r'wine_variety_descriptors.csv', index_col='index')

# our word2vec model for all wine and food terms
wine_word2vec_model = Word2Vec.load(r'food_word2vec_model.bin')
word_vectors = wine_word2vec_model.wv 

# a file with the average wine nonaroma vectors for each nonaroma
food_nonaroma_infos = pd.read_csv(r'average_nonaroma_vectors.csv', index_col='Unnamed: 0')
