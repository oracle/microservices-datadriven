...
kubectl apply -f resources/prom_msdataworkshop_servicemonitors.yaml -n msdataworkshop
...
kubectl create configmap db-teq-orderpdb-exporter-config --from-file=./resources/db-teq-orderpdb-exporter-metrics.toml -n msdataworkshop
kubectl create configmap db-teq-inventorypdb-exporter-config --from-file=./resources/db-teq-inventorypdb-exporter-metrics.toml -n msdataworkshop
# informational only...
...
kubectl apply -f resources/db-teq-exporter-orderpdb-deployment.yaml -n msdataworkshop
kubectl apply -f resources/db-teq-exporter-orderpdb-service.yaml -n msdataworkshop
kubectl apply -f resources/db-teq-exporter-inventorypdb-deployment.yaml -n msdataworkshop
kubectl apply -f resources/db-teq-exporter-inventorypdb-service.yaml -n msdataworkshop
