...
import org.example.oracle.cqrs.command.commands.BaseCommand;
...
public class CommandsProducer {
    ...
    public CommandsProducer(JmsTemplate jmsTemplate, @Value("${txeventq.queue.commands.name}") String queueName) {
